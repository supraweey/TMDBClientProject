...
fun HttpException.handleHttpError() {
    when (code()) {
        HTTP_ERROR_CODE_400 -> throw NewServiceException(ERROR_CODE_HCA001)
        HTTP_ERROR_CODE_404 -> throw NewServiceException(ERROR_CODE_HCA002)
        HTTP_ERROR_CODE_500 -> throw NewServiceException(ERROR_CODE_HCA003)
        HTTP_ERROR_CODE_502 -> throw NewServiceException(ERROR_CODE_HCA004)
        HTTP_ERROR_CODE_503 -> throw NewServiceException(ERROR_CODE_HCA005)
        else -> throw NewServiceException(ERROR_CODE_HCA999)
    }
}